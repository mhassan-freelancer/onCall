<li><a href=""><i class="fa fa-circle-o text-red"></i> <span>Alarms</span></a></li>
<li><a href="system_users.php"><i class="fa fa-circle-o text-yellow"></i> <span>Admin</span></a></li>
...
<li><a href="update_page.php"><i class="fa fa-circle-o text-yellow"></i> <span>Update</span></a></li>
